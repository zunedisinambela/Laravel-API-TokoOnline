...
<div class="box box-primary">
    <div class="box-body">
        <div>
            <a href="{{ route('product.index') }}" class="btn btn-sm btn-primary"><span class="fa fa-arrow-left"></span> Kembali</a>
        </div>
            ...
            <table class="table table-striped table-hover table-responsive" id="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('uploads/'.$image->image) }}" alt="" width="240px" height="120px">
                        </td>
                    </tr>
                    @endforeach
                </tbody>
